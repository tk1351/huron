...
import { TagsPagePresentaional } from './TagsPagePresentaional'
import { MainPagePresentational } from '../MainPage/MainPagePresentational'
...
export const TagsPageContainer: FC = () => (
  <TagsPagePresentaional tag={tagName}>
    <MainPagePresentational articles={articles} pageCount={5} />
  </TagsPagePresentaional>
)
